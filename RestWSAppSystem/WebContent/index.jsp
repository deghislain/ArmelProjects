...
<html>
	...
	<body>
		<div style="align-content: center; border-color: #333333; width: 95%; height: 635px; border-style: solid; border-width: 1px; padding-left: 65px">
			...
			<form method="Post" action="SmallServicesController">
				<div>
			...
			<form action="SmallServicesController" method="Post">
			...
			<form action="SmallServicesController" method="Post" enctype="multipart/form-data">
				<div style="padding-top: 5px">
					<H3>File Upload</H3>
